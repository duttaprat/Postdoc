...
parent_folder_path  = "/data/projects/GDC_Cancer_Wise/Brain/Data/SUB_VCF/"+ folder_name
...
df_acceptor_bed = pd.read_csv("/data/private/pdutta/DNABERT_data/Splice_sites/Acceptor_raw_files/Unique_Acceptor_RAW_Combined_BED.tsv", sep="\t")
acceptor_bed = pybedtools.BedTool.from_dataframe(df_acceptor_bed)
...
output_path = "/data/projects/GDC_Cancer_Wise/Brain/Data/Preprocessed_file/" + folder_name
