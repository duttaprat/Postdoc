...
intersected_data = "/data/projects/GDC_Cancer_Wise/{}/Data/Intersected_data/intersected_{}_data.pkl".format(cancer_type, non_coding_region)
reference_path  = "/data/projects/Resources/Gencode_genome_annotation/GRCh38.primary_assembly.genome.fa"
dnabert_output_path = "/data/private/pdutta/DNABERT_data/Genetic_variant/{}/{}".format(cancer_type, non_coding_region)
raw_output_path = "/data/projects/GDC_Cancer_Wise/{}/Data/Sequence_generation/".format(cancer_type)
...
with open(raw_output_path+"raw_{}_vcf_data.pkl".format(non_coding_region), "wb") as file:
