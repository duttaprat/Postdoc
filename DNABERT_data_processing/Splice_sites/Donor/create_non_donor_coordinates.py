...
chr_num=sys.argv[1]
data_df=pd.read_csv("/home/pdutta/Data/Splicesites_data/Donor_splice_sites/"+chr_num+"_donor_splice_set.csv", sep=",")
...
# print(data_df.head())
start_pos=(data_df['coordinates']-100).to_list()
end_pos = ((data_df['coordinates']+100).to_list())
# print(start_pos)
# print(end_pos)
