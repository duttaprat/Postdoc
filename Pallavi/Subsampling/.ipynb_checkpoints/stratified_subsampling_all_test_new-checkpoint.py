...
for i in range(no_of_iteration):
    ...
    for index, row in df_1s_t_test.iterrows():
        ...
        df_1s_t_test.loc[index, ['ITER_{}'.format(i)]]= pt1
        df_2s_t_test.loc[index, ['ITER_{}'.format(i)]]= pt2
        df_1sg_wilcox.loc[index, ['ITER_{}'.format(i)]]= pw1g
        df_1ss_wilcox.loc[index, ['ITER_{}'.format(i)]]= pw1s
        df_2s_wilcox.loc[index, ['ITER_{}'.format(i)]]= pw2
    #print (df_p_values)
