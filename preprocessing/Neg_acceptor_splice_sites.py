...
acceptor_path = "/mnt/data05/shared/pdutta_data/Human_Genome_Data/Acceptor_splice_sites/"
non_acceptor_path = "/mnt/data05/shared/pdutta_data/Human_Genome_Data/Non_acceptor_splice_sites/"
...
for file in chr_files:
    ...
    if file.endswith('.fa'):
        ...
        for i in removed_flat_list:
            temps =  Non_acceptor_sequence[i-35:i+34]
