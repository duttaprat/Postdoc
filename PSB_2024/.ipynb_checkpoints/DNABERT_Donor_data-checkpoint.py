...
chr_wise_files = glob.glob('/data/private/pdutta/PSB_Data_2024/Donor/Chrwise/*.tsv')
reference_path  = "/data/projects/Resources/HumanReferenceGenome/"
output_path = "/data/projects/PSB/DNABERT_data/Donor" 
...
for chromosome in chromosomes:
    ...
    if (chromosome_name != 'chrM'):
        ...
        df = pd.read_csv('/data/private/pdutta/PSB_Data_2024/Donor/Chrwise/intersected_DBSNP_transcript_'+chromosome_name+'_data.tsv', header=None, sep= '\t')
        print(df.shape)
        #df= df[df[15]==2]
        #df = df.head(15)
        print(df.head())
